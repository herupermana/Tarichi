...
class Ajax_things extends Master_Controller
{
    ...
    public function show_image($nama_file_gambar, $nama_file_thumb)
    {
    ...
    public function save_comment($the_post_id)
    {
    ...
    public function load_sub_menu($the_page_id)
    {
    ...
    public function image_library2()
    {
