...
{
    public function create_menu($home_cap = 'Home', $open_page = '', $open_tag = '<li>', $close_tag = '</li>')
    {
        $top_menu = '';
    ...
    public function search_box($classbox = 'btncari', $valuebox = 'Cari Disini', $idbox = 'cari_disini', $classbtn = 'tblcari', $valuebtn = 'Cari')
    {
