...
class Comment_model extends CI_Model
{
    ...
    {
        $querycek = $this->db->get_where('the_post', ['the_post_id'=>$this->the_post_id]);
        $rowcek = $querycek->row();
    ...
    public function get_comment($the_post_id, $site_comment_moderation)
    {
    ...
    public function get_by_parent($parent_comment_id, $site_comment_moderation)
    {
        if ($site_comment_moderation == 1) {
            $this->db->where('comment_status', 1);
        }
    ...
    public function get_last_comment($to_show = 10, $site_comment_moderation)
    {
    ...
    public function get_pending($pending = 'no', $start = 0)
    {
        $this->db->join('the_post', 'the_post.the_post_id=comment.the_post_id');
